      ...
      <div className="wrapper">
        ...
        <div className="body" style={{padding: "20px !important"}}>
          <a href="https://github.com/archivine">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" className="svg" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
          ...
          <a href="https://steamcommunity.com/id/archivine">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" className="svg" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
          ...
          <a href="https://discord.gg/lunasb">
            <img src="luna.png" className="imgIc" alt="luna"/>
          </a>
          <a href="https://steamcommunity.com/groups/tuxcart">
            <img src="kito.gif" className="imgIc" alt="kito"/>
          </a>
        </div>
      </div>
    );
